...
from pypong.player import BasicAIPlayer, KeyboardPlayer, MousePlayer, WheelPlayer
...
def run():
    ...
    #player_right = KeyboardPlayer(input_state, pygame.K_o, pygame.K_l)

    player_left = WheelPlayer("/dev/ttyACM0")
    player_right = WheelPlayer("/dev/ttyUSB0")
